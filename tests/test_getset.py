...
class GetSetTestCase(unittest.TestCase):
    ...
    def test_getitem_recarray_single(self):
        ...
        testing.assert_array_almost_equal(test.get_values_pix(test.valid_pixels), values["col1"])
    ...
    def test_getitem_array(self):
        ...
        indices = np.array([1.0, 2, 100, 500, 10000])
    ...
    def test_setitem_single(self):
        ...
        sparse_map[1000] = 1.0
        full_map[1000] = 1.0
        testing.assert_array_almost_equal(sparse_map.generate_healpix_map(), full_map)
    ...
    def test_setitem_recarray_single(self):
        ...
        self.assertRaises(RuntimeError, sparse_map["col1"].__setitem__, 10000, 10.0)
    ...
    def test_setitem_integer(self):
        ...
        sparse_map = healsparse.HealSparseMap.make_empty(
            nside_coverage=nside_coverage, nside_sparse=nside_map, dtype=pxvalues.dtype
        )
